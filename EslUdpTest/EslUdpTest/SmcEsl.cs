...
namespace EslUdpTest
{
    ...
    public class SmcEsl
    {
        ...
        System.Timers.Timer BufferPackageLoseTimer = new System.Timers.Timer(300);
        System.Timers.Timer EslPackageLoseTimer = new System.Timers.Timer(300);
        ...
        */
        ...
        private void ReceiverUpdateUI(string deviceIP, byte[] data)
        {
            ...
            else if (data[0] == 0x13)
            {
                ...
                // Read Version
                else if (data[2] == 0x02 && data[data.Length - 1] == newR_BCC(data))//Read Version 成功
                {
                ...
                else if (data[2] == 0x02 && data[data.Length - 1] != newR_BCC(data))
                {
                    SMCEslReceiveEventArgs obj = new SMCEslReceiveEventArgs();
                    obj.msgId = msg_ReadEslVersion;
                    obj.status = false;
                ...
                // Read Battery
                else if (data[2] == 0x03 && data[data.Length - 1] == newR_BCC(data))//Read Battery 成功
                {
                    // AB02 * 440 / 100 = 3.07
                    //430
                ...
                else if (data[2] == 0x03 && data[data.Length - 1] != newR_BCC(data))
                {
                    SMCEslReceiveEventArgs obj = new SMCEslReceiveEventArgs();
                    obj.msgId = msg_ReadEslBattery;
                    obj.status = false;
                ...
                else if (data[2] == 0x04 && data[data.Length - 1] == newR_BCC(data))//Read Manufacture Date 成功
                {
                    receivedText = receivedText.Substring(2, receivedText.Length - 4);
                    byte[] temp = Tools.StringToByteArray(receivedText);
                    SMCEslReceiveEventArgs obj = new SMCEslReceiveEventArgs();
                ...
                else if (data[2] == 0x04 && data[data.Length] != newR_BCC(data))
                {
                    SMCEslReceiveEventArgs obj = new SMCEslReceiveEventArgs();
                    obj.msgId = msg_ReadManufactureData;
                    obj.status = false;
                ...
                //------------ 2018/03/23 ------------------------
                else if (data[2] == 0x05 && data[data.Length - 1] == newR_BCC(data))
                {
                    SMCEslReceiveEventArgs obj = new SMCEslReceiveEventArgs();
